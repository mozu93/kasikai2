...
def main():
    ...
    if not rooms:
        print("⚠️  会議室が検出されませんでした。手動で設定する必要があります。")
        return
